"""
Comprehensive tests for NASDAQ API response dataclasses.
"""
...
from src.nasdaq.models.market import NewsArticle
from src.nasdaq.models.market import PressRelease
